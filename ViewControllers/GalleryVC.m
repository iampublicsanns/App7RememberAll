...
- (void)startLoadingCatalogue
{
	...
	NSURLSessionDataTask *task = [session dataTaskWithURL:url completionHandler:^(NSData *_Nullable data, NSURLResponse *_Nullable response, NSError *_Nullable error) {
		...
		id json = [GalleryVC sessionCheckData:data response:response error:error];


		NSArray<NSDictionary *> *images = [weakSelf handleGetPublicPhotosJSON:json];
...
{
	return [GalleryVC makeUrlStringFromJSON:json suffix:@"z"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	url = [GalleryVC makeUrlStringFromJSON:json suffix:@"b"];
